...
public final class Autos {
  ...
  public final static CommandBase placeConeAndExit(DriveTrain driveTrain, IntakeSubsystem intakeSubsystem, ArmSubsystem armSubsystem) {
    return Commands.sequence(
      Commands.race(
        Commands.startEnd(() -> {armSubsystem.setArmSpeed(ArmConstants.fast_speed);}, () -> {armSubsystem.setArmSpeed(0);}),
        new WaitCommand(1.5)
  ...
  public final static CommandBase testLeavePlaceAndBalanceAutoCube(DriveTrain driveTrain, IntakeSubsystem intakeSubsystem, ArmSubsystem armSubsystem, LEDSubsystem ledSubsystem) {
    return Commands.sequence(
      Commands.race(
        Commands.startEnd(() -> {armSubsystem.setArmSpeed(ArmConstants.fast_speed);}, () -> {armSubsystem.setArmSpeed(0);}),
        new WaitCommand(1.5)
  ...
  public final static CommandBase testLeavePlaceAndBalanceAutoCone(DriveTrain driveTrain, IntakeSubsystem intakeSubsystem, ArmSubsystem armSubsystem, LEDSubsystem ledSubsystem) {
    return Commands.sequence(
      Commands.race(
        Commands.startEnd(() -> {armSubsystem.setArmSpeed(ArmConstants.fast_speed);}, () -> {armSubsystem.setArmSpeed(0);}),
        new WaitCommand(1.5)
